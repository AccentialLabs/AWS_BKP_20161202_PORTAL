				  ...
				  <form class="form-horizontal" role="form" method="post" action="inserCompany" id="companyForm"  enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        <div class="form-group col-md-8">
                            ...
                            <div class="col-sm-12">
                                <input type="file" class="form-control mandatory_fild isPhoto" 
                                       id="data[Company][logo]" name="data[Company][logo]" placeholder="Logo"  />
								<input type="hidden" id="data[Company][hasPhoto]"  name="data[Company][hasPhoto]" class="hasPhoto"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="data[Company][corporate_name]" name='data[Company][corporate_name]' placeholder="Razão Social" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="data[Company][fancy_name]" name='data[Company][fancy_name]' placeholder="Nome Fantasia" required />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control cnpj mandatory_fild registerCompanyCNPJ" 
                                       id="data[Company][cnpj]" name="data[Company][cnpj]" placeholder="CNPJ" required />
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control phone mandatory_fild" 
                                       id="data[Company][phone]" name="data[Company][phone]" placeholder="Telefone" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control phone" 
                                       id="data[Company][phone_2]" name="data[Company][phone_2]" placeholder="Telefone 2" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="email" class="form-control mandatory_fild registerCompanyEmail" 
                                       id="data[Company][email]" name="data[Company][email]" placeholder="Email" required />
                    ...
                    <div class="row">
                        <div class="form-group col-md-8">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="data[Company][responsible_name]" name="data[Company][responsible_name]" placeholder="Nome e Sobrenome" required />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild registerCompanyResponsibleEmail" 
                                       id="data[Company][responsible_email]" name="data[Company][responsible_email]" placeholder="Email" required />
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild registerCompanyResponsibleBirthday" 
                                       id="data[Company][responsible_birthday]" name="data[Company][responsible_birthday]" placeholder="Data de Nascimento" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control cpf mandatory_fild registerCompanyCPF" 
                                       id="data[Company][responsible_cpf]" name="data[Company][responsible_cpf]" placeholder="CPF" required />
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control phone mandatory_fild" 
                                       id="data[Company][responsible_phone]" name="data[Company][responsible_phone]" placeholder="Telefone" required />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-2">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="cep" name="data[Company][cep]" placeholder="CEP" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="logradouro" name="data[Company][address]" placeholder="Endereço" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="data[Company][number]" name="data[Company][number]" placeholder="Número" required />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="bairro" name="data[Company][district]" placeholder="Bairro" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild"  
                                       id="localidade" name="data[Company][city]" placeholder="Cidade" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control mandatory_fild" 
                                       id="uf" name="data[Company][uf]" placeholder="UF" required />
                            </div>
                        </div>
                    </div>
					 <hr />
  ...
  <div class="col-sm-6 col-md-12">
	...
	<small>
      ...
      <div class="caption row">
		<div class="col-md-4">
						<label  class="control-label label-padding">Fui indicado por:</label>
                            <div class="dropdown open">
                                <input type="text" class="form-control" placeholder="Digite o nome" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"/> 
<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="meuMenuDropDown">

  </ul>
  <input type="hidden" id="indicationUserID" name="indicationUserID" />

                            </div> 
							 <small>* Caso não tenha sido indicado, deixe os campos em branco</small>
		</div>
		...
		<div class="col-md-2">
		<label  class="control-label label-padding">Código da indicação:</label>
                            <div>
                                <input type="text" class="form-control" id="indicationCode" name="indicationCode"/>
								<small><span id="errorFromIndicationCode"></span></small>
                            </div>
		</div>
      </div>
