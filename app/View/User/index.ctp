...
<div>
	...
	<?php
		...
		<?php }?>
        <li class="active"><a data-toggle="tab" href="#sectionB" data-step="1" data-intro="Aqui você vê todos os profissionais cadastrados no seu salão">Profissionais e Permissões</a></li>
        <li><a data-toggle="tab" href="#sectionC">Cargos</a></li>
        <li><a data-toggle="tab" href="#sectionD">Usuários Removidos</a></li>
		 <li><a data-toggle="tab" href="#sectionE" data-step="2" data-intro="Relação de profissionais-parceiros (associados)">Profissionais Associados</a></li>
	...
	<?php
        ...
        <div id="sectionB" class="tab-pane fade in active">
            ...
            <button id="buttonAddNewUser" type="button" class="btn btn-primary pull-right" data-step="3" data-intro="Cadastre aqui os profissionais que trabalham em seu salão" data-position="left">
