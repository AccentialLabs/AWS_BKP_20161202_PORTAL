...
<?php $this->Html->css('tablesorter/themes/blue/style', array('inline' => false)); ?>
<?php $this->Html->script('util', array('inline' => false)); ?>
<?php $this->Html->script('View/Product.index', array('inline' => false)); ?>


<?php $this->Html->script('../css/tablesorter/jquery-latest', array('inline' => false)); ?>
<?php $this->Html->script('../css/tablesorter/jquery.tablesorter', array('inline' => false)); ?>
...
<h1 class="page-header" style="margin-top: -58px;">Produtos/Ofertas</h1>
...
<div id="">
    ...
    <div class="tab-content" id="sections">
        <div id="sectionA" class="tab-pane fade">
            <table class="table table-bordered table-condensed small tablesorter"  id="minhaTabela">
                <thead>
                    <tr>
                        <th class="col-md-3">Titulo</th>
                        <th>Valor Total</th>
                        <th>Valor Com Desc.</th>
                        <th>Porc.<br/>de desc.</th>
                        <th>Inicio</th>
                        <th>Final</th>
                        <th>Status</th>
                     <th><small>Cliques em detalhe</small></th>
                        <th><small>Cliques em comprar</small></th>
                        <th><small>Compras com boleto</small></th>
                        <th><small>Compras com cartão</small></th>
                        <th>Avaliação</th>
        ...
        <div id="sectionB" class="tab-pane fade in active">
            <table class="table table-bordered table-condensed small tablesorter" id="activeOffers">
                <thead>
                    <tr>
                        <th class="col-md-3">Titulo</th>
                        <th>Valor Total</th>
        ...
        <div id="sectionC" class="tab-pane fade">
            <table class="table table-bordered table-condensed small tablesorter" id="inactiveOffer">
                <thead>
                    <tr>
                        <th class="col-md-3">Titulo</th>
                        <th>Valor Total</th>
