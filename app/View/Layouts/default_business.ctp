        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="dashboard" id="linkedLogo"><?php echo $this->Html->image('jezzy_logo/jezzylogo.png', array('class' => 'logoNav')); ?></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
				
					
                    <ul class="nav navbar-nav navbar-right">
						<li class="text-center" style="margin-right: 10px; opacity: 0.8;">
							<!-- MOSTRAR AVISO DE CONTAGEM, CASO O USUÁRIO TENHA O PLANO TRIAL-->
						<?php  
							if(!empty($this->Session->read('CompanyPlan'))){
								
								$plan = $this->Session->read('CompanyPlan');
								
								if($plan[0]['company_plans']['plan'] === 'TRIAL' && $plan[0]['company_plans']['TRIAL_COUNTER'] > 0){
									
									echo "<div id='countTRIAL'><small><small>Restam </small><strong>{$plan[0]['company_plans']['TRIAL_COUNTER']}</strong><small> dias para o fim do plano TRIAL</small><br/><a style='color: #fff; cursor: pointer;' id='goToUpgrade'>FAZER UPGRADE <span class='step size-12'>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar marginMenu"  id="menuBusiness">
                    <div id="menuBusinessIcon">
                        <ul class="nav nav-sidebar">
                            <li class="<?php echo $title_for_layout == "Dashboard" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('<span class="step size-24">
                    <i class="ionicons ion-ios-home-outline"></i>
					</span>', '/dashboard', array('class' => 'dashboad', 'escape' => false)); ?>
                            </li>
							
                            <li class="<?php echo $title_for_layout == "Produtos" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('<span class="step size-24">
					<i class="ionicons ion-ios-pricetags-outline"></i>
					</span>', '/product', array('class' => 'product', 'escape' => false)); ?>
                            </li>
                    ...
                    <div id="menuBusinessFull">
                        <ul class="nav nav-sidebar">
                            <li class="<?php echo $title_for_layout == "Dashboard" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('<span class="step size-24">
                    <i class="ionicons ion-ios-home-outline"></i>
					</span>	   Dashboard', '/dashboard', array('class' => 'dashboad', 'escape' => false)); ?>
                            </li>
                            ...
                            <li class="<?php echo $title_for_layout == "Produtos" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('<span class="step size-24">
					<i class="ionicons ion-ios-pricetags-outline"></i>
					</span>	   Prod./Ofertas', '/product', array('class' => 'product', 'escape' => false)); ?>
                            </li>
							<?php }?>
					...
					</span> Agenda', '/schedule', array('class' => 'schedule', 'escape' => false)); ?>
                            </li>
								<?php
                            if ($this->Session->read('userLoggedType') != 2) { ?>
                            <li class="">
                                <a><span class="step size-24">
					<i class="ionicons ion-ios-list-outline"></i>
                            ...
                            <li class="<?php echo $title_for_layout == "Rel.Cliente" ? "active" : ""; ?>">
							 ...
							 <li class="<?php echo $title_for_layout == "Rel. Comissionamento" ? "active" : ""; ?>">
                                <?php echo $this->Html->link('Comissionamento', '/comissionReport', array('class' => 'linkMenu', 'escape' => false)); ?>
                            </li>
                            ...
                            if ($this->Session->read('userLoggedType') != 2) {
                                ...
                                echo '
                                    <li class="">
                                        <a><span class="step size-24"><i class="ionicons ion-ios-gear-outline"></i></span>Configurações</a>
                                    </li>
                                    <li class="'.$userActive.'">
